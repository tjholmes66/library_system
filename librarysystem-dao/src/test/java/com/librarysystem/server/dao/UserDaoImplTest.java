...
public class UserDaoImplTest extends BaseDaoTests
{
    @Autowired
    ...
    public void testGetUserEntityByUsername()
    {
        ...
        userEntity = userDao.getUserEntityByUsername(username);
    ...
    public void testGetUserEntityByResetKey()
    {
        ...
        userEntity = userDao.getUserByResetKey(resetKey);
    ...
    public void testGetUserEntityByEmailAddress()
    {
        ...
        userEntity = userDao.getUserByEmailAddress(emailAddress);
